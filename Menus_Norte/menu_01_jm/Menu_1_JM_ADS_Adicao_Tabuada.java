...
import exercicios_todos.Exercicios_Indice_Adicao_Tabuada;
 ...
 * @author ana 
 */
public class Menu_1_JM_ADS_Adicao_Tabuada extends javax.swing.JPanel {

    Home Home;
    Controle_de_Alterar_Menu_Norte Controle_de_Alterar_Menu_Norte;
        
    public Menu_1_JM_ADS_Adicao_Tabuada( Home Home2, Controle_de_Alterar_Menu_Norte Controle_de_Alterar_Menu_Norte2 ) {
        Home = Home2;
    ...
    private void initComponents() {
        ...
        btExercicios8.setText("Tabuada de Adição");
        btExercicios8.setEnabled(false);
    ...
    private void btExercicios5MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btExercicios5MousePressed
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 );
            ...
            Home.ControleTabs.AddTabsAoHome("Exercícios - Tabuada de Adição", "/imagens_internas/livroTp.gif", new Exercicios_Indice_Adicao_Tabuada(Home) ); 
