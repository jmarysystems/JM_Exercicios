...
public class PopupMenu_Colar extends PopupMenu
{
	...
	public PopupMenu_Colar(JTextComponent jTextComponent)
	{
		this(jTextComponent,"Recortar", "Copia","Colar","Deletar","Selecionar Tudo");
	}
	public PopupMenu_Colar(JTextComponent jTextComponent, String cut, String copy, String paste, String delete, String selectAll)
	{
		super();
